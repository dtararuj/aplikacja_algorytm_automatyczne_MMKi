...
folder<-"Z:/PRODUKT/NOWE SKLEPY/algorytm zwrotÛw pod zatowarowanie"    #gdzie sa dane

gdzie_nie_junior<-c("SKLEP RACIB”RZ")
gdzie_nie_jeansy<-c("SKLEP KUTNO", "SKLEP G£OWNO", "STRZELCE OPOLSKIE")

folder_skryptow<- "Z:/PRODUKT/NOWE SKLEPY/algorytm zwrotÛw pod zatowarowanie/skrypty"   #folder gdzie sa skrypty
